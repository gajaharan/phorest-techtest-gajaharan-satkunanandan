...
import com.phorest.data.Product;
...
public class UploadIntegrationTest {
    ...
    public void shouldReturn201_whenCsvFilesAreUploadedSuccessfullyAndSavedToDatabase() {
        ...
        final ResponseEntity appointmentResponse =
        ...
        final ResponseEntity purchaseResponse =
        ...
        Optional<Product> purchaseProduct = productRepository.findById("d2d3b92d-f9b5-48c5-bf31-88c28e3b73ac");
        ...
        assertEquals(HttpStatus.CREATED, purchaseResponse.getStatusCode());
        Optional<Product> serviceProduct = productRepository.findById("f1fc7009-0c44-4f89-ac98-5de9ce58095c");
