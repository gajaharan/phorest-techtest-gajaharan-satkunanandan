...
@Component
public class PurchaseCsvParser implements CsvParser<PurchaseProduct> {

    @Override
    public List<PurchaseProduct> read(InputStream data) {
        return read(data, ProductCsvRecord.class);
    }

    public static class ProductCsvRecord implements CsvMapper<PurchaseProduct> {
